...
public class RestCsrfPreventionFilterFuzzerJazzer {
    ...
    public static void fuzzerTestOneInput(FuzzedDataProvider data) {
        ...
        try {
            ...
            doTest(METHOD_POST, REMOVE_ALL_CUSTOMERS, CREDENTIALS, invalidbody.getBytes(StandardCharsets.ISO_8859_1), USE_COOKIES, HttpServletResponse.SC_FORBIDDEN, null, str2, true, Constants.CSRF_REST_NONCE_HEADER_REQUIRED_VALUE);
        } catch (Exception e) {
        }
    }

    public static void doTest(String method, String uri, BasicCredentials credentials, byte[] body, boolean useCookie, int expectedRC, String expectedResponse, String nonce, boolean expectCsrfRH, String expectedCsrfRHV) throws Exception {
    ...
    public static void addNonce(Map<String, List<String>> reqHeaders, String nonce, Predicate<String> tester) {
        if (tester.test(nonce)) {
            addRequestHeader(reqHeaders, Constants.CSRF_REST_NONCE_HEADER_NAME, nonce);
        }
    }

    public static void addCredentials(Map<String, List<String>> reqHeaders, BasicCredentials credentials, Predicate<BasicCredentials> tester) {
    ...
    public static int methodUrl(String path, ByteChunk out, int readTimeout, Map<String, List<String>> reqHead, Map<String, List<String>> resHead, String method, boolean followRedirects) throws IOException {
    ...
    public static int postUrl(final byte[] body, String path, ByteChunk out, Map<String, List<String>> reqHead, Map<String, List<String>> resHead) throws IOException {
    ...
    public static int postUrl(boolean stream, BytesStreamer streamer, String path, ByteChunk out, Map<String, List<String>> reqHead, Map<String, List<String>> resHead) throws IOException {
        URL url = new URL(path);
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
