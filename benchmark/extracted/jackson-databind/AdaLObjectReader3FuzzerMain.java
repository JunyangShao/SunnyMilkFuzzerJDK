...
public class AdaLObjectReader3FuzzerMain {
                    ...
                    switch(data.consumeInt(0, 7)) {
                        ...
                        case 7:
                            ...
                            switch(data.consumeInt(0, 1)) {
                                ...
                                case 1:
                                    r.readValue(SMFData, classes[fuzzInt1]);
                            }
                    }
                case 2:
    ...
    public static Class[] classes = { DummyClass.class, Integer.class, String.class, Byte.class, List.class, Map.class, TreeMap.class, BitSet.class, TimeZone.class, Date.class, Calendar.class, Locale.class, Long.class };
    ...
    public static final class NoCheckSubTypeValidator extends PolymorphicTypeValidator.Base {
