...
public class DataTypeConverterFuzzerJazzer {
    ...
    public static void fuzzerTestOneInput(FuzzedDataProvider fuzzedDataProvider) {
        DataTypeConverterFuzzer testClosure = new DataTypeConverterFuzzer(fuzzedDataProvider.consumeInt(), fuzzedDataProvider.consumeRemainingAsString());
        testClosure.test();
    }
}
