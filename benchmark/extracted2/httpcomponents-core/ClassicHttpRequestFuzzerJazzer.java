...
public class ClassicHttpRequestFuzzerJazzer {
    ...
    public static void fuzzerTestOneInput(FuzzedDataProvider data) {
        ...
        HttpRequester requester = RequesterBootstrap.bootstrap().setSslContext(null).setMaxTotal(2).setDefaultMaxPerRoute(2).create();
