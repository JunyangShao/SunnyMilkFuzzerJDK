...
$JAVA_HOME/bin/javac LauncherTest.java

g++ -fPIC -pthread -I"$JAVA_HOME/include" -I"$JAVA_HOME/include/linux" -I./fuzzer -L"${JAVA_HOME}/lib/server" -L./fuzzer -o FuzzerLauncher FuzzerLauncher.cpp -ljvm -lFuzzer -ldl
